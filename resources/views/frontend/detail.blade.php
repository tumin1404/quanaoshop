...
<head>
    <meta charset="utf-8">
    <title>Min Fashion-Chi tiết sản phẩm</title>
    ...
    <div class="container-fluid py-5">
        <div class="row px-xl-5">
                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner border">
                        <div class="carousel-item active">
                            <img style="width:500px;height:600px" src="/upload/sanpham/@{{sanpham.image}}" alt="Image">
                        </div>
                    </div>
            ...
            <div class="col-lg-5 pb-5 ml-5">
                ...
                <h3 class="font-weight-semi-bold mb-4">@{{sanpham.gia_km | currency :'' :0}}@{{sanpham.don_vi_tinh}}</h3><h3 class="text-muted ml-2"><del>@{{sanpham.unit_price | currency :'' :0}}@{{sanpham.don_vi_tinh}}</del></h3>
                <!-- <p class="mb-4">@{{sanpham.mota_sp}}</p> -->
                <div class="d-flex mb-3">
                ...
                <div class="d-flex align-items-center mb-4 pt-2">
                    ...
                    <a href="/frontend/cart"><button class="btn btn-primary px-3" ng-click="addToCart(sanpham)"><i class="fa fa-shopping-cart mr-1"></i>Thêm vào giỏ hàng</button></a>
        ...
        <div class="row px-xl-5">
            <div class="col">
                <div class="owl-carousel related-carousel">
                    <div class="card product-item border-0" ng-if="sanpham.id_loai_sp==sp.id_loai_sp" ng-repeat="sp in listsanpham | orderBy :'-id'| limitTo :4 :5">
